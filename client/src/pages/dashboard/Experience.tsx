...
const Experience = ({ experience, deleteExperience }: { experience: any, deleteExperience: any }) => {
  ...
  const experiences = experience.map((exp: any) => (
    <tr key={exp._id}>
      ...
      <td>
        <Link to={{ pathname: `/edit-experience/${exp._id}`}} className="btn btn-light">
  ...
  const experiences2 = experience.map((exp: any) => (
