...
// Authorize User
export const authorize = (email: string, token: string) => async (dispatch: Dispatch) => {
  const config = {
    headers: {
      'Content-Type': 'application/json',
    },
...
// Set Recovery Token
export const recoveryPassword = (email: string) => async (dispatch: Dispatch) => {
  const config = {
    headers: {
      'Content-Type': 'application/json',
    },
...
// Set new password
export const changePassword = (email: string, password: string, token: string) => async (dispatch: Dispatch) => {
  const config = {
    headers: {
      'Content-Type': 'application/json',
    },
